...
SWIFT_MODULE_NAMESPACE_PUSH("HomeHero")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC8HomeHero11AppDelegate")
...
SWIFT_CLASS("_TtC8HomeHero22HomeHeroViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified trackingInfo;
- (void)viewDidLoad;
...
@interface HomeHeroViewController (SWIFT_EXTENSION(HomeHero)) <ARSCNViewDelegate>
...
SWIFT_CLASS("_TtC8HomeHero16SelectableButton")
